...
public class StoreListAdapter extends BaseAdapter {
	...
	private List<StoreListVo> items;
	private LayoutInflater layoutInflater;

	public StoreListAdapter(Context context) {
		this.items = new ArrayList<StoreListVo>();
		this.layoutInflater = LayoutInflater.from(context);
	}

	public void setItems(List<StoreListVo> items) {
		this.items.clear();
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if (convertView == null) {
			...
			convertView = this.layoutInflater.inflate(R.layout.item_store_list,
					null);
...
//		}
		if(position<items.size()){
			StoreListVo item = items.get(position);
